        ...
        <Card className="mb-8 border-blue-200 bg-blue-50">
          <CardContent className="p-4">
            <div className="flex items-start gap-3">
              ...
              <div>
                <p className="font-medium text-blue-800">Proceso de Aprobación</p>
                <p className="text-sm text-blue-700 mt-1">
                  Tu producto será revisado por nuestro equipo antes de ser publicado. Este proceso puede tomar entre
                  24-48 horas. Te notificaremos por email cuando sea aprobado.
                </p>
              </div>
            </div>
          </CardContent>
          ...
          <div className="grid lg:grid-cols-3 gap-8">
            ...
            <div className="lg:col-span-2 space-y-8">
              ...
              <Card>
                ...
                <CardContent className="space-y-6">
                  <div className="grid md:grid-cols-3 gap-4">
                    <div>
                      ...
                      <p className="text-xs text-gray-500 mt-1">
                        Tu comisión: 15% = {formData.price ? formatPrice(Number.parseInt(formData.price) * 0.15) : "$0"}
                      </p>
                    </div>
                  ...
                  <div className="grid md:grid-cols-2 gap-4">
                    <div>
                      <label className="block text-sm font-medium text-gray-700 mb-2">SKU (Opcional)</label>
                      <input
                        type="text"
                        name="sku"
                        value={formData.sku}
            ...
            <div className="space-y-8">
              ...
              <Card className="border-green-200 bg-green-50">
                <CardHeader>
                  <CardTitle className="text-green-800">Tu Comisión</CardTitle>
                </CardHeader>
                <CardContent>
                  <div className="space-y-3">
                    ...
                    <div className="flex justify-between">
                      <span className="text-green-700">Por venta:</span>
                      <span className="font-semibold text-green-800">
                        {formData.price ? formatPrice(Number.parseInt(formData.price) * 0.15) : "$0"}
                      </span>
                    </div>
                    <div className="border-t border-green-200 pt-2">
                      <div className="flex justify-between">
                        <span className="text-green-700">Precio cliente:</span>
                        <span className="font-semibold text-green-800">
                ...
                <Card>
                  ...
                  <CardContent>
                    <div className="border rounded-lg p-4">
                      ...
                      <Badge className="mt-2 ml-2 text-xs bg-orange-100 text-orange-800">Pendiente Aprobación</Badge>
                    </div>
                  </CardContent>
                </Card>
              )}
