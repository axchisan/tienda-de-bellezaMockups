  ...
  return (
    <div className="min-h-screen bg-white">
            ...
            <div className="space-y-8">
              ...
              <div className="flex flex-col sm:flex-row gap-4">
                <Link href="/products">
                  <Button
                    size="lg"
                    className="bg-slate-900 hover:bg-slate-800 text-white px-8 py-4 text-base font-medium"
                  >
                    Comprar Ahora
                ...
                <Button
                  variant="outline"
                  size="lg"
                  className="border-slate-300 text-slate-700 hover:bg-slate-50 px-8 py-4 text-base font-medium bg-transparent"
                >
                  Ver Colección
                </Button>
              </div>
              ...
              <div className="flex items-center gap-12 pt-8">
                <div className="text-center">
                  ...
                  <div className="text-sm text-slate-500">Clientes Felices</div>
                </div>
                <div className="text-center">
      ...
      <section className="py-20 bg-slate-50">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            <h2 className="text-4xl font-light text-slate-900 mb-4">Compra por Categoría</h2>
      ...
      <section className="py-20 bg-white">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            <h2 className="text-4xl font-light text-slate-900 mb-4">Productos Destacados</h2>
            <p className="text-xl text-slate-600 max-w-2xl mx-auto">
      ...
      <section className="py-20 bg-slate-50">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            <h2 className="text-4xl font-light text-slate-900 mb-4">¿Por qué elegirnos?</h2>
          </div>

          <div className="grid md:grid-cols-3 gap-8">
            <Card className="text-center p-8 border-0">
              <MessageCircle className="h-12 w-12 text-slate-700 mx-auto mb-4" />
              <h3 className="text-xl font-semibold text-slate-900 mb-2">Chat en Vivo</h3>
              <p className="text-slate-600">Asesoría personalizada con nuestros expertos en belleza</p>
            </Card>

            <Card className="text-center p-8 border-0">
              <Calculator className="h-12 w-12 text-slate-700 mx-auto mb-4" />
              <h3 className="text-xl font-semibold text-slate-900 mb-2">Calculadora de Envíos</h3>
              <p className="text-slate-600">Conoce el costo exacto de envío a tu ciudad</p>
            </Card>

            <Card className="text-center p-8 border-0">
              <Award className="h-12 w-12 text-slate-700 mx-auto mb-4" />
              <h3 className="text-xl font-semibold text-slate-900 mb-2">Programa de Puntos</h3>
              <p className="text-slate-600">Acumula puntos y obtén descuentos en tus compras</p>
            </Card>
          </div>
        </div>
      </section>
      ...
      <section className="py-20 bg-slate-900">
        <div className="container mx-auto px-4 text-center">
          <div className="max-w-2xl mx-auto text-white">
            <h2 className="text-4xl font-light mb-4">Mantente Actualizada</h2>
            ...
            <div className="flex flex-col sm:flex-row gap-4 max-w-md mx-auto">
              ...
              />
              <Button className="bg-white text-slate-900 hover:bg-slate-100 px-8">Suscribirse</Button>
            </div>
